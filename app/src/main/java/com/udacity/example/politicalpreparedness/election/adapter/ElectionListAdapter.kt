package com.udacity.example.politicalpreparedness.election.adapter
...
import com.udacity.example.politicalpreparedness.databinding.ViewholderElectionBinding
...
class ElectionListAdapter(
    ...
    private val clickListener: ElectionListAdapter.ElectionListener
) : ListAdapter<ElectionModel, ElectionListAdapter.ElectionViewHolder>(
